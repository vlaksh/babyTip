...
var buildNewClassProperty = function buildNewClassProperty(t, classPropertyName, newMethodName) {
  ...
  var newArrowFunction = t.arrowFunctionExpression([t.restElement(t.identifier('params'))], returnExpression);
