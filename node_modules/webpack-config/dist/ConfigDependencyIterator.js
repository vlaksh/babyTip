...
var ConfigDependencyIterator = function (_RecursiveIterator) {
  ...
  function ConfigDependencyIterator(root) {
    var bypassMode = arguments.length <= 1 || arguments[1] === undefined ? 0 : arguments[1];
    var ignoreCircular = arguments.length <= 2 || arguments[2] === undefined ? true : arguments[2];
    var maxDeep = arguments[3];
    (0, _classCallCheck3.default)(this, ConfigDependencyIterator);
    return (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(ConfigDependencyIterator).call(this, root, bypassMode, ignoreCircular, maxDeep));
  }
