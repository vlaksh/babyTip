...
var ConfigPatternCache = function (_Map) {
    ...
    function ConfigPatternCache() {
        var interpolate = arguments.length <= 0 || arguments[0] === undefined ? DEFAULT_INTERPOLATE : arguments[0];
        (0, _classCallCheck3.default)(this, ConfigPatternCache);

        var _this = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(ConfigPatternCache).call(this));
    ...
    (0, _createClass3.default)(ConfigPatternCache, [{
        ...
        value: function set(key, value) {
            return (0, _get3.default)((0, _getPrototypeOf2.default)(ConfigPatternCache.prototype), 'set', this).call(this, key, this.compile(value));
        }
